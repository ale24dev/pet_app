...
/// @nodoc
@JsonSerializable()
class _$_BreedModel implements _BreedModel {
  const _$_BreedModel({required this.id, required this.name});
...
abstract class _BreedModel implements BreedModel {
  const factory _BreedModel(
      {required final int id, required final String name}) = _$_BreedModel;
